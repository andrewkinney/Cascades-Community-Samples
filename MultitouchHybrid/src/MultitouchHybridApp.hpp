...
#ifndef MULTITOUCHHYBRIDAPP_HPP
#define MULTITOUCHHYBRIDAPP_HPP
...
class MultitouchHybridApp : public QObject
{
    Q_OBJECT
...
private:
	...
	MultitouchView *m_pMultitouch;
};

#endif // ifndef MULTITOUCHHYBRIDAPP_HPP
